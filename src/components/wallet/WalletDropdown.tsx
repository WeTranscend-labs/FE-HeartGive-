...
const WalletDropdown = ({
  ...
  return (
    <section
      className="w-full bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden min-w-[300px] backdrop-blur-lg"
      ...
      {isAdmin && (
        <div className="px-5 pb-4">
          <Button
            ...
            className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-emerald-500 to-green-600 text-whitehover:from-emerald-600 hover:to-green-700 transition-all duration-300 ease-in-out 
